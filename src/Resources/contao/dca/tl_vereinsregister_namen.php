...
(
	...
	(
		...
		'pid' => array
		(
			'foreignKey'              => 'tl_vereinsregister.id',
		...
		'overwriteMeta' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_vereinsregister_namen']['overwriteMeta'],
			'inputType'               => 'checkbox',
		...
		'imageTitle' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_vereinsregister_namen']['imageTitle'],
			'exclude'                 => true,
			'search'                  => true,
			'inputType'               => 'text',
			'eval'                    => array('maxlength'=>255, 'tl_class'=>'w50'),
		...
		'published' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_vereinsregister_namen']['published'],
			'exclude'                 => true,
			'search'                  => false,
			'sorting'                 => false,
			'filter'                  => true,
...
class tl_vereinsregister_namen extends Backend
{
	...
	public function listHistory($arrRow)
	{
		...
		$temp = '<div class="cte_type ' . $key . '">Vereinsname</div>';
